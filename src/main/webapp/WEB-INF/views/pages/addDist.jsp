...
<body>
	<div class="container">
		<form action="${pageContext.request.contextPath}/saveDistrict"
			...
			<div class="row">
				<div class="col-md-6">
					<label>Country Name</label> <select
						class="form-select form-select-lg mb-3 mycss" name="countryId" id="country"
			...
			<div class="row">
				<div class="col-md-6">
					<label>District Name</label><input type="text" name="distName"
						class="form-control">
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<label>District Code</label><input type="text" name="distCode"
						class="form-control">
				</div>
			</div>
