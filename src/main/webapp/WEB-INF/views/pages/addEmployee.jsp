...
<script>
	function add() {
		...
		$('#multAddress').append('<div class="form-group"><input type="file" name="addressProfs" id="new_'+new_chq_no+'"><div>');
				...
				<div class="row">
					...
					<div class="text-center">${message }</div>
						...
						<form:form
							...
							modelAttribute="employeeVo" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<form:select class="form-control" onchange="getDist();"
									path="state_id" id="state_id">
							...
							<div class="form-group">
								...
								<form:select path="dist_id" id="distId" onchange="getcity();"
									class="form-control">
									<c:forEach items="${districtList }" var="district">
										<form:option value="${district.id }">${district.distName }</form:option>
									</c:forEach>
								</form:select>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Pincode </label>
								<form:input type="number" path="adr_pinno" class="form-control"
									required="true" />
							</div>
							<div class="form-group">
								<div class="row">
